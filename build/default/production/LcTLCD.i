...
void CantaPartAlta(char c) {
  (LATEbits.LATE2 = (c & 0x80 ? 1 : 0));
  (LATEbits.LATE1 = (c & 0x40 ? 1 : 0));
  (LATEbits.LATE0 = (c & 0x20 ? 1 : 0));
  (LATAbits.LATA5 = (c & 0x10 ? 1 : 0));
}

void CantaPartBaixa(char c) {
  (LATEbits.LATE2 = (c & 0x08 ? 1 : 0));
  (LATEbits.LATE1 = (c & 0x04 ? 1 : 0));
  (LATEbits.LATE0 = (c & 0x02 ? 1 : 0));
  (LATAbits.LATA5 = (c & 0x01 ? 1 : 0));
}

void CantaIR(char IR) {
 (TRISAbits.TRISA5 = TRISEbits.TRISE0 = TRISEbits.TRISE1 = TRISEbits.TRISE2 = 0);
 (LATAbits.LATA2 = 0);
 (LATAbits.LATA3 = 0);
 (LATAbits.LATA4 = 1);
 CantaPartAlta(IR);
 ...
 (LATAbits.LATA4 = 1);
 (LATAbits.LATA4 = 0);
 (TRISAbits.TRISA5 = TRISEbits.TRISE0 = TRISEbits.TRISE1 = TRISEbits.TRISE2 = 1);
}
...
void WaitForBusy(void) { char Busy;
 ...
 TI_ResetTics(Timer);
 do {
  (LATAbits.LATA4 = 1);(LATAbits.LATA4 = 1);
  Busy = (PORTEbits.RE2);
  (LATAbits.LATA4 = 0);
  (LATAbits.LATA4 = 0);
  (LATAbits.LATA4 = 1);(LATAbits.LATA4 = 1);
...
void EscriuPrimeraOrdre(char ordre) {
 ...
 (TRISAbits.TRISA5 = TRISEbits.TRISE0 = TRISEbits.TRISE1 = TRISEbits.TRISE2 = 0); (LATAbits.LATA2 = 0); (LATAbits.LATA3 = 0);
 (LATAbits.LATA4 = 1); (LATAbits.LATA4 = 1);
  (LATEbits.LATE2 = (ordre & 0x08 ? 1 : 0));
  (LATEbits.LATE1 = (ordre & 0x04 ? 1 : 0));
  (LATEbits.LATE0 = (ordre & 0x02 ? 1 : 0));
  (LATAbits.LATA5 = (ordre & 0x01 ? 1 : 0));
 (LATAbits.LATA4 = 0);
}
