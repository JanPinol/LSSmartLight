...
# 6 "./TAD_TECLATMATRIU.h" 2
# 27 "./TAD_TECLATMATRIU.h"
const unsigned char T_REBOTS = 10;
...
# 9 "./TAD_MENU.h" 2
# 21 "./TAD_MENU.h"
const unsigned char uid_saved[6][5] = {
...
static unsigned char leds_saved[6][6] = {
    {0, 0, 0, 0, 0, 0},
    {1, 2, 3, 4, 5, 6},
    {10, 10, 10, 10, 10, 10},
    {1, 1, 1, 1, 1, 1},
...
void MFRC522_AntennaOn() {
    unsigned char stt = MFRC522_Rd(0x14);
...
unsigned char MFRC522_Rd(unsigned char Address) {
    ...
    for (i = 8; i > 0; i--) {
        LATDbits.LATD7 = ((ucAddr & 0x80) == 0x80);
        LATBbits.LATB0 = 1;
        ucAddr <<= 1;
        LATBbits.LATB0 = 0;
    }
...
void MFRC522_Wr(unsigned char Address, unsigned char value) {
    ...
    for (i = 8; i > 0; i--) {
        LATDbits.LATD7 = ((value & 0x80) == 0x80);
        LATBbits.LATB0 = 1;
        value <<= 1;
        delay_us(3);
        LATBbits.LATB0 = 0;
...
void motorRFIDcoop(void) {
    ...
    switch (state) {
        ...
        case 4:
            _status = MFRC522_ToCard(0x0C, UID, 2, UID, &unLen);
            break;

        case 5:
            if (_status == 0) {
                for (i = 0; i < 4; i++) serNumCheck ^= UID[i];
                if (serNumCheck != UID[4]) _status = 2;
            }
            UID[5] = 0;
        ...
        case 8:
            _status = MFRC522_ToCard(0x0C, buff, 4, buff, &unLen);
            break;
...
void motorRFIDcoop_NOU(void) {
    ...
    switch (state) {
        ...
        case 1:
            _status = MFRC522_ToCard_NOU(0x0C, TagType, 1, TagType, &backBits);
            break;
        ...
        case 4:
            _status = MFRC522_ToCard_NOU(0x0C, UID, 2, UID, &unLen);
            break;
        ...
        case 8:
            _status = MFRC522_ToCard_NOU(0x0C, buff, 4, buff, &unLen);
            break;
