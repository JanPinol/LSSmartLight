...
static unsigned char intensitat[6];
static unsigned char TimerLed[6];

void LEDS_Init(void) {
    TRISBbits.TRISB7 = TRISBbits.TRISB6 = TRISBbits.TRISB5 = TRISBbits.TRISB4 = TRISBbits.TRISB3 = TRISBbits.TRISB2 = 0;
    LATBbits.LATB7 = LATBbits.LATB6 = LATBbits.LATB5 = LATBbits.LATB4 = LATBbits.LATB3 = LATBbits.LATB2 = 0;
...
void LEDS_setState(unsigned char quinLed, unsigned char estat) {
    switch (quinLed) {
        case 0: LATBbits.LATB7 = estat; break;
        case 1: LATBbits.LATB6 = estat; break;
        case 2: LATBbits.LATB5 = estat; break;
        case 3: LATBbits.LATB4 = estat; break;
        case 4: LATBbits.LATB3 = estat; break;
        case 5: LATBbits.LATB2 = estat; break;
    }
}
...
void LEDS_Motor(unsigned char quinLed) {
    ...
    switch(state[quinLed]) {
        ...
        case 1:
            if (TI_GetTics(TimerLed[quinLed]) >= (10 - intensitat[quinLed])) {
                LEDS_setState(quinLed, 1);
                TI_ResetTics(TimerLed[quinLed]);
                state[quinLed]--;
            }
