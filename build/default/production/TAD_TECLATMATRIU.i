...
void TM_Init(void) {
    ...
    TRISDbits.TRISD2 = TRISDbits.TRISD1 = TRISCbits.TRISC4 = 1;
    TRISDbits.TRISD0 = TRISDbits.TRISD4 = TRISCbits.TRISC5 = TRISDbits.TRISD3 = 0;
    LATDbits.LATD0 = LATDbits.LATD4 = LATCbits.LATC5 = LATDbits.LATD3 = 0;
...
void TM_Motor(void) {
    switch(state) {
        case 0:
            LATDbits.LATD4 = LATCbits.LATC5 = LATDbits.LATD3 = 0;
            LATDbits.LATD0 = 1;
            row_selected = 0;
            state = 4;
            break;
        ...
        case 1:
            LATDbits.LATD0 = LATCbits.LATC5 = LATDbits.LATD3 = 0;
            LATDbits.LATD4 = 1;
            row_selected = 1;
            state = 4;
            break;
        ...
        case 2:
            LATDbits.LATD0 = LATDbits.LATD4 = LATDbits.LATD3 = 0;
            LATCbits.LATC5 = 1;
            row_selected = 2;
            state = 4;
            break;
        ...
        case 3:
            LATDbits.LATD0 = LATDbits.LATD4 = LATCbits.LATC5 = 0;
            LATDbits.LATD3 = 1;
            row_selected = 3;
            state = 4;
            break;
    ...
    case 4:
        if (PORTDbits.RD2 || PORTDbits.RD1 || PORTCbits.RC4) {
...
unsigned char TM_IsKeyPressed(void) {
    return (PORTDbits.RD2 || PORTDbits.RD1 || PORTCbits.RC4);
}
